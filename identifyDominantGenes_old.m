...
%         ix=ix+1;
    ...
    pairwiseDominance=selfMinTest & pairwisePrctEffectTests & pairwiseFCexprTests & (pairwiseExprTests|pairwisePrctTests);
    
    %pairwise other pooling
...
%     selfDominant(:,i)=all(pairwiseTests,2);
    ...
    minFCexprTest(:,i)=all(pairwiseTests,2);
